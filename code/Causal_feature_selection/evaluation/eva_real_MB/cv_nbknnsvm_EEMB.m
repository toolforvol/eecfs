function [mean_knn_accuracy] = cv_nbknnsvm_EEMB(data, class_label, cv_indices, dataset, alpha, maxK)
...
for i = 1:10
    ...
    % Use EEMB_G2 algorithm to obtain Markov Blanket
    [mb, ntest, ntime] = EEMB_G2(train_data, target, alpha, ns, p, maxK);
    time(i) = ntime;
    test(i) = ntest;

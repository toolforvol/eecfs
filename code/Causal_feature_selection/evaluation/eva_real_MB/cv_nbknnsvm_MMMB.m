function [mean_knn_accuracy] = cv_nbknnsvm_MMMB(data, class_label, cv_indices, dataset, alpha, maxK)
...
for i = 1:10
    ...
    % Use MMMB_G2 algorithm to obtain Markov Blanket
    [mb, ntest, ntime] = MMMB_G2(train_data, target, alpha, ns, p, maxK);
    % [mb, ntest, ntime] = MMMB_Z(train_data, target, alpha, ns, p, maxK);
    disp(mb)
    time(i) = ntime;
    test(i) = ntest;

function [mean_knn_accuracy] = cv_nbknnsvm_CFS_MI(data, class_label, cv_indices, dataset, alpha, maxK)
...
for i = 1:10
    ...
    [mb, ntest, ntime] = CFS_MI_G2(train_data, target, alpha, ns, p, maxK);
    time(i) = ntime;
    test(i) = ntest;

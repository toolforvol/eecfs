...
NonTPC = mysetdiff(1:p,myunion(PC,target)); % P represents a set of positive integers from 1 to p, obtaining indices of other features that are not in the target variable PC

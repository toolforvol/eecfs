...
function [CPC,test,time,dSep] = MBOR_PC_G2(Data,target,alpha,ns,p,maxK)
%
...
[PCS,ntest_PCS,sepset]=PCSuperSet_G2(Data, target, alpha, ns, p, maxK);

[SPS,ntest_SPS] = SPSuperSet_G2(Data, target, alpha, PCS, sepset, ns, p, maxK);

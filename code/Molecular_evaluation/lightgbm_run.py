...
model_file = f"../../result/DNA/{alg_name}_LightGBM.model"
...
try:
    ...
    print("[Train] LightGBM script output:")
    print(result.stdout)

except subprocess.CalledProcessError as e:
    print("LightGBM script execution failed!")
    print(e.stderr)
...
try:
    ...
    print("[Test] LightGBM script output:")
    print(result.stdout)
